...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(ejercicio2.esPalindromo(palabra1)); // true
        System.out.println(ejercicio2.esPalindromo(palabra2)); // false
    }
    ...
    private static void runLinkList() {
        ...
        // Agregamos los mismos elementos a nombres2 para usar la variable
        nombres2.add("Juan");
        nombres2.add("pedro");
        nombres2.add("Maria");
        nombres2.add("Diago");
        ...
        System.out.println("Desde ArrayList (O(1)): " + nombres2.get(4));
